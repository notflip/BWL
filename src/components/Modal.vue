...
<script>
    ...
    export default {
        ...
        mounted () {
            ...
            this.loading = false
            this.$el.addEventListener(window.webkitAnimationEnd ? 'webkitAnimationEnd' : 'animationend', this.onAnimationEnded, false)
        },

        beforeDestroy () {
            this.$el.removeEventListener(window.webkitAnimationEnd ? 'webkitAnimationEnd' : 'animationend', this.onAnimationEnded, false)
        },
